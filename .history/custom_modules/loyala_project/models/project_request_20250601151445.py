...
class LoyalaProjectRequest(models.Model):
    ...
    hpp_unit = fields.Float(string='Unit Cost', compute='_compute_costs', store=True, readonly=True)
    var_cost = fields.Float(string='Variable Cost', compute='_compute_costs', store=True, readonly=True)
    sample_cost = fields.Float(string='Sample Cost', compute='_compute_costs', store=True, readonly=True)
